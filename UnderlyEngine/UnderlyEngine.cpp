...
namespace Cosmos {
    namespace Engine {
        ...
        void UnderlyEngine::onInitParams(Types::InitParam const & initParamMap) {
            ...
            m_engineParam.kbarBiasSeconds = stoi(Utils::getParamMapValue(initParamMap.paramMap, "kbarBiasSeconds"));
            ...
            m_engineParam.riskInformVolume = stoi(Utils::getParamMapValue(initParamMap.paramMap, "riskInformVolume"));
            m_engineParam.riskOpenVolume = stoi(Utils::getParamMapValue(initParamMap.paramMap, "riskOpenVolume"));
            m_engineParam.riskMaxOrderRatio = stoi(Utils::getParamMapValue(initParamMap.paramMap, "riskMaxOrderRatio"));
        ...
        void UnderlyEngine::onRtnQuerySymbolPosition(Types::OnQuerySymbol const &onQuerySymbol) {
            ...
            auto itr = m_symbolMap.find(onQuerySymbol.instrumentInfo->instrumentID);
        ...
        void UnderlyEngine::onEventData(Types::EventData const &eventData) {
            if (eventData.eventType == Types::EventType::marketEvent) {
                ...
                m_executor->onOrderField(inputOrder, symbol);
