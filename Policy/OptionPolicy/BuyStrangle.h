//
// Created by zhangyingwei on 2024/8/26.
//

#ifndef OPTIONTRADING_CALENDARSPREAD_H
#define OPTIONTRADING_CALENDARSPREAD_H
#include "Strangle.h"
...
namespace Cosmos {
    namespace Policy {
        ...
        class BuyStrangle : public Strangle {
        private:
            int m_configIndex{0};
        ...
        public:
            BuyStrangle( Types::KPeriod kperiod, double mv,std::string const&policyName,
...
#endif //OPTIONTRADING_CALENDARSPREAD_H
